    ...
    <LayoutNoNav>
      <section className="flex flex-col justify-center items-center text-sp-white">
        ...
        <div className="flex flex-col w-full justify-center items-center text-center gap-3">
          ...
          <a href="/auth/register/email" className="inline-flex items-center justify-start w-full bg-sp-black border  border-sp-lighter rounded-sp-40 p-4 text-lg font-semibold text-sp-white">
            <div className="w-1/5 p-2">
              <svg
                width="16"
                height="13"
