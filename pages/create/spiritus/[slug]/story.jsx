...
export default function CreateStoryPage() {
  ...
  const showCurrentStep = () => {
    switch (step) {
      // case 1:
      //   return <ChooseType type={type} setType={setType} />;
      // case 2:
      //   return (
    ...
    <div className="flex flex-col items-center my-4 gap-1 w-1/2 mx-auto sm:w-full md:w-1/2">
      ...
      <div className="flex flex-col items-center gap-1 mt-5">
        <p className="mt-1 text-center text-sp-white opacity-50 mb-8 w-3/4 text">
          ...
          <span>{spiritus.name} </span>
          <span>{spiritus.surname}</span>
        </p>
      </div>
      <div className="flex mx-auto items-center justify-center gap-4 mt-3 text-sp-white">
        ...
        <Link href={`/create/spiritus/${spiritus.slug}/story`}>
          <a className="flex flex-col items-center justify-center h-24 hover:bg-gradient-to-r hover:from-sp-dark-brown hover:to-sp-brown rounded-lg p-4">
            <PlusCircleIcon />
