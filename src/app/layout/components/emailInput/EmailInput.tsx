    ...
    <>
      <div className="container">
        <div className="row justify-content-center">
          <div className="col col-12 emailSuccess">
            <div className=""> ✓ Great, we’ll be in touch! </div>
          </div>
          <div className="beFirst">
            {" "}
            <p>
              {" "}
              Be the first to know when we are ready to beta-test our new
              Android app (iOS coming later).
            </p>
          </div>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <div className="beFirst">
          ...
          <p>
            {" "}
            Be the first to know when we are ready to beta-test our new Android
            app (iOS coming later).
          </p>
        </div>
      </form>
    </OutsideClickHandler>
