        ...
        <div className="relative flex flex-col items-center">
          <div className="w-full">
            <div className="flex appearance-none text-sp-black outline-none dark:text-sp-white">
              ...
              <div className="flex w-8 items-center py-1 pl-2 pr-1 text-gray-300">
                <div className="cursor-pointer text-gray-600 outline-none focus:outline-none">
                  {dropdown ? (
...
function Dropdown({ items, addItem }) {
  return (
    <div
      id="dropdown"
      className="max-h-select absolute right-0 top-10 z-40 w-full rounded-sp-10 border border-sp-day-400 bg-sp-day-50 text-sp-black dark:bg-sp-black dark:text-sp-white"
    >
      <div className="flex w-full flex-col p-2">
        {items.map((item, key) => {
          return (
            ...
            >
              <div className="flex w-full items-center p-2 hover:bg-sp-day-900 hover:bg-opacity-40 hover:text-sp-black dark:hover:bg-sp-fawn dark:hover:bg-opacity-100">
