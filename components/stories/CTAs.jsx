...
export function GetSpiritusCTA() {
  ...
  return (
    <div className="h-full w-full rounded-sp-14 bg-[url('/images/photos_bg.png')] bg-cover bg-center py-24">
      <div className="flex flex-col items-center">
        <h2 className="mb-4 text-center font-bold text-sp-black text-2xl -tracking-tight dark:text-sp-white sm:w-3/5 sm:text-3xl md:w-3/4 md:text-cta lg:w-3/5 lg:text-5xl">
...
export function CreateSpiritusCTA({ sessionStatus, openModal }) {
  ...
  return (
    <div className="h-full w-full rounded-sp-14 bg-[url('/images/photos_bg.png')] bg-center py-24">
      <div className="flex flex-col items-center">
        <h2 className="mb-4 text-center font-bold text-sp-black text-2xl -tracking-tight dark:text-sp-white sm:w-3/5 sm:text-3xl md:w-3/4 md:text-cta lg:w-3/5 lg:text-5xl">
          {t("cta_create_spiritus_title")}
        </h2>
...
export function SearchSpiritusCTA() {
  ...
  return (
    <div className="mb-10 flex flex-col items-center rounded-sp-14 bg-gradient-to-r from-sp-day-300 to-sp-day-100 py-14 text-sp-black dark:from-sp-dark-brown dark:to-sp-brown dark:text-sp-white">
      ...
      <div className="flex flex-col items-center justify-center">
        <h2 className="mb-1 font-extrabold text-2xl">
          {t("find_loved_title")}
        </h2>
        <p className="xl:2/5 mb-5 w-5/6 text-center opacity-60 text-sm md:w-1/2">
...
export function SearchPlacesCTA() {
  ...
  return (
    <div className="items-center justify-center rounded-sp-14 border-3 border-sp-day-200 text-sp-black dark:border-sp-fawn dark:border-opacity-10 dark:text-sp-white">
      <div className="mx-auto flex flex-col items-center px-4 py-14 lg:px-8 lg:py-20">
        <div className="mx-2 mb-2 rounded-sp-10 bg-sp-day-900 bg-opacity-10 p-2 dark:bg-sp-dark-brown">
          <LocationIcon width={6} height={6} />
        </div>
        <h2 className="font-extrabold text-xl sm:text-lg md:text-2xl lg:text-3xl">
          {t("search_places_title")}
        </h2>
        <div className="mx-auto flex w-3/4 flex-wrap items-center justify-center gap-2 pb-4 pt-3 lg:w-3/5">
          {places.map((p) => {
...
export function PlacePill({ name, url }) {
  return (
    <Link
      href={url}
      className="inline-flex items-center rounded-sp-40 bg-gradient-to-r from-sp-day-300 to-sp-day-100 px-3 py-2 font-semibold text-sm focus:outline-none dark:from-sp-dark-brown dark:to-sp-brown"
    >
      <div className="ml-2 inline-flex items-center">
        {name}
        <ChevronRightIcon className="h-4 w-4 text-sp-fawn" />
      </div>
    </Link>
  );
}
...
function CTASearchPlacesButton() {
  ...
  return (
    <Link
      href="/search?filter=place"
      className="inline-flex rounded-sp-40 border-5 border-sp-fawn bg-gradient-to-r from-sp-day-900 to-sp-dark-fawn px-7 py-3 text-sp-white dark:border-sp-medium dark:border-opacity-80 dark:from-sp-dark-fawn dark:to-sp-fawn dark:text-sp-black"
    >
      <ArrowCircleRightIcon className="h-6 w-6" />
      <span className="ml-1 font-semibold">{t("goto_search_places")}</span>
    </Link>
  );
}
...
function CTASearchButton() {
  ...
  return (
    ...
    >
      <ArrowCircleRightIcon className="h-6 w-6" />
      <span className="ml-1 font-semibold">{t("goto_search")}</span>
    </Link>
  );
}
...
export function CTADownloadLinks() {
  ...
  return (
    <div className="text-sp-lighter">
      <ul className="mr-2 inline-flex align-middle">
        <li>
      ...
      <Link
        ...
        className="inline-flex gap-1 px-2 align-middle"
        target="_blank"
      >
        <svg
          width="15"
  ...
  return (
    <div className="mt-4 flex items-center gap-6">
      <div className="relative max-w-xs overflow-hidden bg-cover bg-no-repeat">
        ...
        <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed opacity-25 dark:bg-sp-black"></div>
      </div>
